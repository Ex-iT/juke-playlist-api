...
module.exports = {
	...
	outputFile: process.env.LAMBDA_TASK_ROOT ? path.resolve(process.env.LAMBDA_TASK_ROOT, './server/static/juke-stations') : path.join(__dirname, '..', 'express', 'static', 'juke-stations'),
